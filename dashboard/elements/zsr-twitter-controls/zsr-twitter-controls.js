(function () {
	...
	class zsrTwitterControls extends Polymer.MutableData(Polymer.Element) {
		static get is() {
			return 'zsr-twitter-controls';
		}
	...
	customElements.define(zsrTwitterControls.is, zsrTwitterControls);
})();
