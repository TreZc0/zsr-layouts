(function () {
	...
	class zsrTimekeeper extends Polymer.Element {
		static get is() {
			return 'zsr-timekeeper';
		}
		...
		ready() {
			...
			currentRun.on('change', newVal => {
				...
				runners.length = 1; //adjust this for more runners
				for (let i = 0; i < 1; i++) {
	...
	customElements.define(zsrTimekeeper.is, zsrTimekeeper);
})();
