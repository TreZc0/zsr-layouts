(function () {
	...
	class zsrTimekeeperLegacy extends Polymer.Element {
		static get is() {
			return 'zsr-timekeeper-legacy';
		}
		...
		ready() {
			...
			currentRun.on('change', newVal => {
				...
				runners.length = 2; //adjust this for more runners
				for (let i = 0; i < 2; i++) {
	...
	customElements.define(zsrTimekeeperLegacy.is, zsrTimekeeperLegacy);
})();
