...
function buildHashtagStream() {
    ...
    hashtagStream.on('connection error unknown', function (error) {
        ...
        hashtagStream.stream('statuses/filter', { track: '#ZSRCommunityRace, ZeldaSpeedRuns' });
    });
...
function addTweet(tweet) {
	...
	tweet.text = tweet.text.replace(/#ZSRCommunityRace/ig, '<span class="hashtag">#ZSRCommunityRace</span>');
